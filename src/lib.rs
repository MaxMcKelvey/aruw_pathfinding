...
mod astar_tests {
    ...
    fn check_goal_is_start() {
        ...
        let path = a.get_path((0, 0), (0, 0), vec![], (2, 2), true).unwrap();
    ...
    fn check_goal_one_away_start() {
        ...
        let path = a.get_path((0, 0), (1, 1), vec![], (2, 2), true).unwrap();
    ...
    fn check_larger_empty() {
        ...
        let path = a.get_path((0, 0), (5, 5), vec![], (6, 6), true).unwrap();
    ...
    fn check_larger_with_wall() {
        ...
        let path = a.get_path((0, 0), (5, 5), occ_sqrs, (6, 6), true).unwrap();
